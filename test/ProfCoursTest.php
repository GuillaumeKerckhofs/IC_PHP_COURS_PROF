...
class ProfCoursTest extends TestCase
{
    ...
    public function testAdd()
    {
        ...
        $this->assertEquals($expected, $num_records, "Enregistrement des profs ...\n");
        $this->assertCount($num_records, self::$cours_a, "Enregistrement des profs ...\n");
    ...
    public function testPrintAll()
    {
        ...
        print "################################################################\n\n";
        $this->assertCount(count(Self::$cours_a), $record_cours_a, "Nombre d'enregistrement égale pour Cour\n");
